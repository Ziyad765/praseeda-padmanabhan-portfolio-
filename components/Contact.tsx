...
import { Mail, Phone, MapPin, Send, Globe, BookOpen, Linkedin } from 'lucide-react';
            ...
            {PERSONAL_INFO.blog && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={PERSONAL_INFO.blog} target="_blank" rel="noopener noreferrer" className="text-scientific-primary hover:underline break-all">
                    Microbial Chronicles
                  </a>
                </div>
              </div>
            )}

            {PERSONAL_INFO.researchGate && (
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white rounded-lg shadow-sm text-scientific-secondary">
                  <BookOpen size={24} />
                </div>
                <div>
                  <p className="font-bold text-gray-800">ResearchGate</p>
                  <a href={PERSONAL_INFO.researchGate} target="_blank" rel="noopener noreferrer" className="text-scientific-primary hover:underline break-all">
                    Praseeda Padmanabhan
                  </a>
                </div>
              </div>
            )}
            ...
            {PERSONAL_INFO.linkedin && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noopener noreferrer" className="text-scientific-primary hover:underline break-all">
                    Praseeda Padmanabhan
                  </a>
                </div>
              </div>
