      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="order-2 md:order-1 space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <a href="#" className="px-8 py-3 bg-scientific-accent text-scientific-primary rounded-lg font-bold shadow-md hover:bg-yellow-400 transition-all flex items-center gap-2">
               CV <Download size={18} />
            </a>
          </div>
        </div>
        ...
        <div className="order-1 md:order-2 flex justify-center relative">
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            ...
            {/* Floating Badges */}
            <div className="absolute top-10 -left-10 bg-white p-3 rounded-xl shadow-lg flex items-center gap-3 animate-bounce">
